...
def _summarize_to_ap_style(original_text, lead, dictionary={}, word_limit=300):
...
def process_news_story(chinese_text, lead, referenceLIST=[]):
    """Processes a Chinese news story, translating it to English and summarizing it to AP style."""
    dictionary = {}
    for ref in referenceLIST:
        dictionary[ref[0]] = ref[1]

    summary = _summarize_to_ap_style(chinese_text, lead, dictionary)
