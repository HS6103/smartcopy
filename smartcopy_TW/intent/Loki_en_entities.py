...
def getResult(inputSTR, utterance, args, resultDICT, refDICT, pattern="", toolkitDICT={}):
    ...
    if utterance == "「虔誠軍」（Lashkar-e-Taiba, LET）":
        if CHATBOT:
            ...
            resultDICT["en_entity"].append((''.join(re.findall(r"<[^<]+>([^<]+)</[^<]+>", args[0])), entity_text))
...
if __name__ == "__main__":
    ...
    resultDICT = getResult("「虔誠軍」（Lashkar-e-Taiba, LET）", "「虔誠軍」（Lashkar-e-Taiba, LET）", [], {}, {})
    pprint(resultDICT)