...
MODULE_DICT = {
    "Account": import_from_path("smartcopy_TW_lib_Account", os.path.join(CWD_PATH, "lib/Account.py")),
    "LLM": import_from_path("smartcopy_TW_lib_LLM", os.path.join(CWD_PATH, "lib/LLM.py")),
    "Project": import_from_path("smartcopy_TW_lib_Project", os.path.join(CWD_PATH, "lib/Project.py")),
}
"""
Account 變數清單
[變數] BASE_PATH         => 根目錄位置
