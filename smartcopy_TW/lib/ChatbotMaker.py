...
MODULE_DICT = {
    "Account": import_from_path("smartcopy_TW_lib_Account", os.path.join(CWD_PATH, "Account.py"))
}
"""
Account 變數清單
[變數] BASE_PATH         => 根目錄位置
...
ARGS_PAT = re.compile(r"r\[\]]")
RESPONSE_ORDER_PAT = re.compile(r"^[\*\-\+\d•]+[ \.\)]*")
RESPONSE_MARK_PAT = re.compile(r"^[\"「]|[\"」]$")
MESSAGE_LIMIT = 3500
